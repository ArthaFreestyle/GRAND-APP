 ...
 *
 * The anchor is what a cold deep link needs: opened straight at `/produk/12`,
...
export default function ProdukLayout() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      <Stack.Screen name="index" options={{ title: 'Master Produk', animation: 'none' }} />
      <Stack.Screen
        name="[id]"
        options={{ title: 'Detail Produk', animation: 'slide_from_right' }}
      />
      <Stack.Screen
        name="baru"
        options={{ title: 'Produk Baru', animation: 'slide_from_right' }}
      />
    </Stack>
  );
}
