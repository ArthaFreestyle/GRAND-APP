 ...
 *
 * The anchor is what a cold deep link needs: opened straight at `/pelanggan/12`,
...
export default function PelangganLayout() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      <Stack.Screen name="index" options={{ title: 'Pelanggan', animation: 'none' }} />
      <Stack.Screen
        name="[id]"
        options={{ title: 'Detail Pelanggan', animation: 'slide_from_right' }}
      />
      <Stack.Screen
        name="baru"
        options={{ title: 'Pelanggan Baru', animation: 'slide_from_right' }}
      />
    </Stack>
  );
}
