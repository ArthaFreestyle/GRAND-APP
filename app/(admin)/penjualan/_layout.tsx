 ...
 *
 * The anchor is what a cold deep link needs: opened straight at `/penjualan/12`,
...
export default function PenjualanLayout() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      <Stack.Screen name="index" options={{ title: 'Penjualan', animation: 'none' }} />
      <Stack.Screen
        name="[id]"
        options={{ title: 'Detail Nota', animation: 'slide_from_right' }}
      />
      <Stack.Screen
        name="baru"
        options={{ title: 'Nota Baru', animation: 'slide_from_right' }}
      />
    </Stack>
  );
}
