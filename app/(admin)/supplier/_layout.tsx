 ...
 *
 * The anchor is what a cold deep link needs: opened straight at `/supplier/12`,
...
export default function SupplierLayout() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      <Stack.Screen name="index" options={{ title: 'Supplier', animation: 'none' }} />
      <Stack.Screen
        name="[id]"
        options={{ title: 'Detail Supplier', animation: 'slide_from_right' }}
      />
      <Stack.Screen
        name="baru"
        options={{ title: 'Supplier Baru', animation: 'slide_from_right' }}
      />
    </Stack>
  );
}
